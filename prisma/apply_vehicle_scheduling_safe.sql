...
CREATE TABLE IF NOT EXISTS "VehicleRequestPassenger" (
  "id" TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS "Vehicle_isActive_idx" ON "Vehicle"("isActive");
CREATE INDEX IF NOT EXISTS "VehicleRequest_requesterPersonnelId_idx" ON "VehicleRequest"("requesterPersonnelId");
CREATE INDEX IF NOT EXISTS "VehicleRequest_requestedByUserId_idx" ON "VehicleRequest"("requestedByUserId");
CREATE INDEX IF NOT EXISTS "VehicleRequest_assignedVehicleId_idx" ON "VehicleRequest"("assignedVehicleId");
CREATE INDEX IF NOT EXISTS "VehicleRequest_travelDate_idx" ON "VehicleRequest"("travelDate");
CREATE INDEX IF NOT EXISTS "VehicleRequest_status_idx" ON "VehicleRequest"("status");
CREATE UNIQUE INDEX IF NOT EXISTS "VehicleRequestPassenger_requestId_personnelId_key" ON "VehicleRequestPassenger"("requestId", "personnelId");
CREATE INDEX IF NOT EXISTS "VehicleRequestPassenger_personnelId_idx" ON "VehicleRequestPassenger"("personnelId");

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'VehicleRequest_requesterPersonnelId_fkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'VehicleRequest_requestedByUserId_fkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'VehicleRequest_reviewedById_fkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'VehicleRequest_assignedVehicleId_fkey') THEN
...
DO $$ BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'CalendarActivity')
    AND NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'VehicleRequest_calendarActivityId_fkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'VehicleRequestPassenger_requestId_fkey') THEN
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'VehicleRequestPassenger_personnelId_fkey') THEN
