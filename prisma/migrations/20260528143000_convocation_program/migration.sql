...
CREATE TABLE "ConvocationGroupMember" (
  "id" TEXT NOT NULL,
...
CREATE TABLE "ConvocationTemplateItem" (
  "id" TEXT NOT NULL,
...
CREATE TABLE "ConvocationProgram" (
  "id" TEXT NOT NULL,
...
CREATE TABLE "ConvocationProgramItem" (
  "id" TEXT NOT NULL,
...
CREATE TABLE "ConvocationAssignmentHistory" (
  "id" TEXT NOT NULL,
  "programId" TEXT NOT NULL,
  "groupId" TEXT NOT NULL,
  "personnelId" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "ConvocationGroup_name_key" ON "ConvocationGroup"("name");
CREATE INDEX "ConvocationGroup_sortOrder_idx" ON "ConvocationGroup"("sortOrder");
CREATE INDEX "ConvocationGroup_isActive_idx" ON "ConvocationGroup"("isActive");
CREATE UNIQUE INDEX "ConvocationGroupMember_groupId_personnelId_key" ON "ConvocationGroupMember"("groupId", "personnelId");
CREATE INDEX "ConvocationGroupMember_personnelId_idx" ON "ConvocationGroupMember"("personnelId");
CREATE INDEX "ConvocationGroupMember_isActive_idx" ON "ConvocationGroupMember"("isActive");
CREATE UNIQUE INDEX "ConvocationTemplateItem_itemKey_key" ON "ConvocationTemplateItem"("itemKey");
CREATE INDEX "ConvocationTemplateItem_itemOrder_idx" ON "ConvocationTemplateItem"("itemOrder");
CREATE INDEX "ConvocationTemplateItem_isEnabled_idx" ON "ConvocationTemplateItem"("isEnabled");
CREATE UNIQUE INDEX "ConvocationProgram_convocationDate_key" ON "ConvocationProgram"("convocationDate");
CREATE INDEX "ConvocationProgram_groupId_idx" ON "ConvocationProgram"("groupId");
CREATE INDEX "ConvocationProgram_status_idx" ON "ConvocationProgram"("status");
CREATE INDEX "ConvocationProgram_convocationDate_idx" ON "ConvocationProgram"("convocationDate");
CREATE UNIQUE INDEX "ConvocationProgramItem_programId_itemKey_key" ON "ConvocationProgramItem"("programId", "itemKey");
CREATE INDEX "ConvocationProgramItem_assignedPersonnelId_idx" ON "ConvocationProgramItem"("assignedPersonnelId");
CREATE INDEX "ConvocationProgramItem_itemOrder_idx" ON "ConvocationProgramItem"("itemOrder");
CREATE UNIQUE INDEX "ConvocationAssignmentHistory_programId_rotationKey_key" ON "ConvocationAssignmentHistory"("programId", "rotationKey");
CREATE INDEX "ConvocationAssignmentHistory_groupId_rotationKey_idx" ON "ConvocationAssignmentHistory"("groupId", "rotationKey");
CREATE INDEX "ConvocationAssignmentHistory_personnelId_idx" ON "ConvocationAssignmentHistory"("personnelId");
CREATE INDEX "ConvocationAssignmentHistory_convocationDate_idx" ON "ConvocationAssignmentHistory"("convocationDate");
